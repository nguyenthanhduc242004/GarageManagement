...
public class CarBrandSpinnerAdapter extends ArrayAdapter<String> {
    public CarBrandSpinnerAdapter(@NonNull Context context, int resource, @NonNull List<String> objects) {
